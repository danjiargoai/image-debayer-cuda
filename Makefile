...
INCLUDES  := -I../../common/inc -I/usr/local/include/opencv
LIBRARIES :=
...
HQDebayer.o:HQDebayer.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

debayer_kernels.o:debayer_kernels.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

HQDebayer: HQDebayer.o debayer_kernels.o
...
clean:
	rm -f HQDebayer HQDebayer.o debayer_kernels.o
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/HQDebayer
